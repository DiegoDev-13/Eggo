...
export const FormRegister = ({handleSubmit, onSubmit, register, errors}) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col my-8 md:my-0 space-y-5 justify-center">
        ...
        <div className="flex w-full gap-5 items-center">
            ...
            <div className="w-full flex flex-col space-y-2">
                ...
                <input type="text" placeholder="Green Vally Poultry" id="farmName" {...register("farmName")} autoComplete="off" className="outline-none w-full dark:text-white bg-white dark:bg-theme-secondary-dark h-14 md:h-11 p-3 rounded-md border border-gray-300 dark:border-gray-600" />
                {
        ...
        <div className="flex flex-col space-y-2">
            ...
            <div className="flex items-center w-full bg-white dark:bg-theme-secondary-dark h-14 md:h-11 p-3 rounded-md border border-gray-300 dark:border-gray-600">
                ...
                <input type={showPassword ? 'text' : 'password'} placeholder="password" id="password" {...register("password")} autoComplete="off" className="p-2 outline-none w-full dark:text-white" />
                {
        ...
        <div className="flex space-x-2 items-center">
            <input type="checkbox" {...register('policyCheck')} id="policyCheck" />
            <label htmlFor="policyCheck" className="text-base md:text-sm dark:text-white">Estoy de acuerdo con los</label>
        ...
        {
            errors.policyCheck && <span className="text-sm text-red-500">{errors.policyCheck.message}</span>
        }
