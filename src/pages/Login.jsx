  ...
  return (
    <>
      <div className="w-full h-dvh flex">
        <div className="w-[90%] relative">
          <div className='absolute top-0 left-0 bg-radial from-[#37963b]/55 dark:from-[#22365c]/50 to-[#051306] dark:to-[#04080f] w-full h-full p-10 flex flex-col justify-between'>
            <div className='flex flex-col space-y-5'>
              <h1 className='text-white text-4xl font-bold'>Eggo App</h1>
        ...
        <div className="w-full bg-theme-primary dark:bg-theme-primary-dark p-5 flex flex-col">
          <div className='p-20 flex flex-col'>
            <h2 className='text-black dark:text-white text-3xl font-medium'>Bienvenido de nuevo</h2>
            <span className='my-3 text-sm text-gray-900 dark:text-white'>Inicia sesión para gestionar tus lotes de aves de corral y tu inventario.</span>
