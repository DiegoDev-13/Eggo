export const MetricCard = ({icon, title, value, trend, trendType, topBorderColor}) => {
  return (
    <div className={`w-30 lg:w-40 h-40 lg:h-50 dark:bg-theme-third-dark flex flex-col space-y-2 border border-gray-500 dark:border-gray-600 py-10 px-5 rounded-xl border-t-4 ${topBorderColor}`}>
