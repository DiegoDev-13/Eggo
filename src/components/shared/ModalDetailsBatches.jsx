                        ...
                        <div className=" grid grid-cols-[75%_25%] flex-1 min-h-0 overflow-hidden rounded-b-lg"> 
                            ...
                            <div className="bg-white border-l dark:bg-theme-primary-dark border-gray-400 overflow-y-auto p-5"> 
                                ...
                                <div className="flex flex-col space-y-3 mt-2">
                                    <button type="button" className="bg-primaryDark-green hover:bg-primary-green dark:bg-green-600 dark:hover:bg-green-700 text-white font-semibold border border-black dark:border-none px-6 py-2 rounded-lg flex items-center gap-2 cursor-pointer hover:scale-102 transition-all duration-300" onClick={handleProduction}>
