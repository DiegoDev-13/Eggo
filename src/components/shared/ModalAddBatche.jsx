                            ...
                            <div className=" grid grid-cols-[70%_30%] flex-1 min-h-0 overflow-hidden rounded-b-lg"> 
                                ...
                                <div className="bg-slate-100 dark:bg-theme-secondary-dark overflow-y-auto py-4 px-8 flex flex-col space-y-3"> 
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)} className="w-full bg-gray-100 dark:bg-theme-secondary-dark py-6 flex flex-col space-y-6 rounded-b-2xl" >
                                        ...
                                        <div className="flex space-x-1">
                                            ...
                                            <h2 className="text-base font-semibold uppercase dark:text-gray-100">Información General</h2>
                                        </div>
                                        ...
                                        <div className="w-full flex justify-between space-x-6">
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="nameBatche" className="font-semibold dark:text-gray-300 text-gray-800">Nombre del Lote <span className="text-red-600 text-xl">*</span></label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <PiTagSimpleLight size={24} className="dark:text-green-500" />
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="dateAdmission" className="font-semibold text-gray-800 dark:text-gray-300 ">Fecha de Ingreso <span className="text-red-600 text-xl">*</span></label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <IoCalendarClearOutline size={20} className="dark:text-green-500" />
                                        ...
                                        <div className="w-full flex justify-between space-x-6">
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="birthDate" className="font-semibold dark:text-gray-300 text-gray-800">Fecha de Nacimiento <span className="text-red-600 text-xl">*</span></label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <MdOutlineEgg size={26} className="dark:text-green-500" />
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="geneticLine" className="font-semibold dark:text-gray-300 text-gray-800">Raza de Lote <span className="text-red-600 text-xl">*</span></label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <MdOutlinePets size={22} className="dark:text-green-500" />
                                                    <input type="text" id="geneticLine" {...register("geneticLine")} className="w-full ml-1 p-2 rounded-lg focus:outline-none dark:text-white transition-all duration-300"  placeholder="Ingresa el nombre de la raza."/>
                                                </div>
                                                {
                                        ...
                                        <div className="w-full flex justify-between space-x-6">
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="initialAmount" className="font-semibold dark:text-gray-300 text-gray-800">Cantidad inicial <span className="text-red-600 text-xl">*</span></label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <MdOutlineInventory2 size={22} className="dark:text-green-500" />
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="initialAmount" className="font-semibold dark:text-gray-300 text-gray-800">Ubicación de Lote <span className="text-red-600 text-xl">*</span></label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <MdOutlineLocationOn size={26} className="dark:text-green-500" />
                                        ...
                                        <div className="w-full flex justify-between  space-x-6">
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="totalDeaths" className="font-semibold dark:text-gray-300 text-gray-800">Total Muertas</label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <RiErrorWarningLine size={24} className="dark:text-green-500" />
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="totalSold" className="font-semibold dark:text-gray-300 text-gray-800">Total Vendidas</label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <PiMoneyFill size={22} className="dark:text-green-500" />
                                        ...
                                        <div className="w-full flex justify-between  space-x-6">
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="nameSupplier" className="font-semibold dark:text-gray-300 text-gray-800">Proveedor</label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <RiTruckLine size={22} className="dark:text-green-500" />
                                            ...
                                            <div className="w-full flex flex-col space-y-1">
                                                <label htmlFor="batchleader" className="font-semibold dark:text-gray-300 text-gray-800">Líder de lote</label>
                                                <div className="bg-white dark:bg-theme-third-dark flex items-center pl-3 border border-gray-500 rounded-lg">
                                                    <MdOutlineSupportAgent size={24} className="dark:text-green-500" />
                                        ...
                                        <div className="w-full flex flex-col space-y-1">
                                            <label htmlFor="AdditionalNotes" className="font-semibold dark:text-gray-300 text-gray-800 ">Notas Adicionales</label>
                                ...
                                <div className="bg-white border-l dark:bg-theme-primary-dark border-gray-400 overflow-y-auto p-5"> 
                                    ...
                                    <div className="py-3 px-5 bg-slate-200 dark:bg-theme-secondary-dark mt-8 rounded-lg border border-gray-500 dark:border-gray-600">
                                        <h3 className="text-green-700 dark:text-green-500 uppercase font-semibold">Quick Tip</h3>
                                        <p className="mt-2 dark:text-gray-200">
                                            Assigning a Batch Leader allows them to receive automated alerts for feed and helth schedules.
                                        </p>
                                    </div>
                                </div> 
                            </div> 
