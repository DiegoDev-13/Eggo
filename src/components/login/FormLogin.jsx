  ...
  return (
    <form className="flex flex-col space-y-5 justify-center">
        <div className="flex flex-col space-y-2">
            <label htmlFor="" className="text-sm dark:text-white">Correo electrónico</label>
            <div className="flex items-center w-full bg-white dark:bg-theme-secondary-dark h-11 p-3 rounded-md border border-gray-300 dark:border-gray-600">
        ...
        <div className="flex flex-col space-y-2">
            <div className="flex justify-between">
                <label htmlFor="" className="text-sm dark:text-white">Contraseña</label>
                <span className="text-sm text-primary-green dark:text-green-500 font-medium cursor-pointer">Has olvidado tu contraseña?</span>
            </div>
            <div className="flex items-center w-full bg-white dark:bg-theme-secondary-dark h-11 p-3 rounded-md border border-gray-300 dark:border-gray-600">
        ...
        <div className="flex space-x-2 ">
            ...
            <label htmlFor="inputCheck" className="text-sm dark:text-white">Acuérdate de mí durante 30 días</label>
        </div>

        <BtnSave text='Iniciar sesión' color='bg-primaryDark-green' darkColor='dark:bg-green-500'/>

        <p className="text-sm dark:text-white mt-2 self-center">¿No tienes una cuenta? <span className="text-primary-green dark:text-green-500 cursor-pointer font-semibold" onClick={() => navigate('/register')}>Inicia tu prueba gratuita</span></p>
    </form>
  )
}